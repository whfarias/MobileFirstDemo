...
function IOSAfterPrepare(projectDirectory) {
    ...
    function addEmbeddedMfpFrameworks(){
        ...
        try {
            ...
            appProj.removeFramework(path.join(projName, 'Plugins', 'cordova-plugin-mfp', 'IBMMobileFirstPlatformFoundationJSONStore.framework'), {customFramework: true});
            appProj.addFramework(path.join(projName, 'Plugins', 'cordova-plugin-mfp', 'IBMMobileFirstPlatformFoundationJSONStore.framework'), {customFramework: true});
            appProj.removeFramework(path.join(projName, 'Plugins', 'cordova-plugin-mfp', 'sqlcipher.framework'), {customFramework: true});
            appProj.addFramework(path.join(projName, 'Plugins', 'cordova-plugin-mfp', 'sqlcipher.framework'), {customFramework: true});
